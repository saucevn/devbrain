    ...
    <div className="mx-auto max-w-6xl px-5 py-10 sm:px-8">
      <header className="rise flex flex-col gap-6 border-b border-line pb-8">
        <div className="flex items-baseline justify-between gap-4">
          ...
          <div className="flex items-center gap-4"><a href="/search" className="font-mono text-xs text-accent hover:underline">⌕ search</a><a href="/entities" className="font-mono text-xs text-accent hover:underline">entities</a><a href="/pyramid" className="font-mono text-xs text-accent hover:underline">pyramid</a><span className="font-mono text-xs text-muted">deterministic backbone · $0 LLM</span></div>
        </div>
